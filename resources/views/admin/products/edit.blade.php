                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="" name="categories[]" value="">
                            <label class="form-check-label" for="">son</label>
                            <input class="form-check-input" type="checkbox" id="" name="categories[]" value="">
                            <label class="form-check-label" for="">kem</label>
                        </div>
